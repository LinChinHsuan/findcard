    ...
    <div class="container h-100 py-5">
      <div class="row h-100 flex-nowrap flex-column justify-content-center">
        ...
        <div class="col-10 col-sm-8 col-md-6 col-xl-4 mx-auto">
          <p class="fs-4 mt-4 mb-3 font-weight-normal text-center">
            請輸入帳號密碼
          </p>
          ...
          <div class="form-floating">
            <input type="password" class="form-control border-top-0" id="floatingPassword" placeholder="Password" v-model="user.password"/>
            <label for="floatingPassword">Password</label>
          </div>
          <button class="btn btn-primary text-white fs-5 fw-bold w-100 my-4 py-2" type="button" @click="signin">
            登入
          </button>
        </div>
      </div>
